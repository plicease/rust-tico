; Copied from the Helix editor's runtime/queries/hcl/highlights.scm
; (https://github.com/helix-editor/helix, at commit 90b126d), which is
...
; repository root.
;
; The tree-sitter-hcl crate ships no highlights query of its own, and
; Helix's already covers the Terraform dialect (var/local/path, the
; type keywords) on top of plain HCL.
