; Copied unmodified from the dekobon fork of tree-sitter-groovy
; (https://github.com/dekobon/tree-sitter-groovy, commit 436a405),
; queries/groovy/highlights.scm. That repo dual-licenses under MIT and
; Apache-2.0; this file is used here under the MIT option, same as the
; rest of tico.
;
