; Copied unmodified from the tree-sitter-powershell crate (v0.26.4,
; https://github.com/airbus-cert/tree-sitter-powershell), queries/highlights.scm.
; MIT, copyright (c) 2023 Airbus CERT.
